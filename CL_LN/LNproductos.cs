...
namespace CL_LN
{
    public class LNproductos
    {
        ...
        public ENproductos ListarProductoxID(int id, string rutaPDFs, string rutaImagenes)
        {
            var res = new ADproductos(rutaPDFs, rutaImagenes).VERSION1_SP_ListarProductoxID(id);
            return res;
        }
        ...
        {
            return new ADproductos().EditarImagenProducto(id_producto, url_imagen, es_principal, es_principal2, id_usuario);
        }
